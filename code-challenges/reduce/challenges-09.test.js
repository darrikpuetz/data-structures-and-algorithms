...
const countNumberOfElements = (arr) => arr.reduce((sum) => sum + 1);
// Solution code here...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const reversedString = (arr) => arr.split('').reduce((first, second) => first = second + first,'');
...
const countNumberOfChildren = (arr) => arr.reduce((first, second) => first + (second.children ? second.children.length : 0), 0);
  // Solution code here...
...
const calculateAverage = (arr) => arr.reduce((first, second) => first + second) /arr.length;
  // Solution code here...
...
const countPrimeNumbers = (arr) => arr.reduce((first, second) => first + (isPrime(second) ? 1 : 0) , 0);
  // Solution code here...
