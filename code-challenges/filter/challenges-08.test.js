...
const oddValues = (arr) => arr.filter(x => x % 2 ===1);
  // Solution code here...
...
const filterStringsWithVowels = (arr) => arr.filter(input =>input.match(/[aeiou]/));
  // Solution code here...
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter(input => !forbiddenValues.includes(input));
  // Solution code here...
...
const getBaseStatGreaterThan = (arr, minBaseStat) => arr.filter(input => input.baseStat > minBaseStat);
  // Solution code here...
...
const getStatName = (arr, minBaseStat) => arr.filter(input => input.baseStat > minBaseStat).map(input => input.stat.name);
  // Solution code here...
...
const getCharactersWithoutChildren = (arr) => arr.filter(input => !input.hasOwnProperty('children'));
  // Solution code here...
